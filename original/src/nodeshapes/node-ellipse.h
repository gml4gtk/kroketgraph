 ...
 * node-ellipse.h
 *
 * Declaration of the NodeEllipse class.
 *
...
#ifndef __NODE_ELLIPSE_H__
#define __NODE_ELLIPSE_H__
...
#define NODE_SHAPE_ELLIPSE "ellipse"


class NodeEllipse : public AbstractNodeShape
{
 public:
  NodeEllipse ( GraphView * );
  virtual ~NodeEllipse ( );
