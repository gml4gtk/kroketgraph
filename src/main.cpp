  ...
  while ( ( c = getopt_long(argc, argv, options, long_options, NULL) ) != -1 )
    {
      switch ( c )
        ...
        case 'f':
          {
            nodeFocus = QString::fromLatin1 ( optarg ); // QString::fromAscii ( optarg );
            break;
          }

        case 't':
          {
            nodeTrace = QString::fromLatin1 ( optarg ); // QString::fromAscii ( optarg );
            break;
          }
        ...
        case 'e':
          {
            expand.append ( QString::fromLatin1 (optarg) ); // QString::fromAscii(optarg)
            break;
          }
        ...
        case 'c':
          {
            collapse.append ( QString::fromLatin1 (optarg) ); // QString::fromAscii(optarg) 
            break;
          }

        case 'w':
          {
            with.append ( QString::fromLatin1 (optarg) ); // QString::fromAscii(optarg)
            break;
          }

        case 'W':
          {
            without.append ( QString::fromLatin1 (optarg) ); // QString::fromAscii(optarg)
            break;
          }
