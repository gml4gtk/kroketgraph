/*
 * anchor-closeddotarrow.cpp
 *
 * Implementation of the AnchorClosedDotArrow object's methods.
 *
...
#include <cmath>
#include "anchor-closeddotarrow.h"
 ...
 * Constructor
 */
AnchorClosedDotArrow::AnchorClosedDotArrow ( AbstractEdgeShape *e,
                                             AnchorType t )
  : AbstractAnchor ( e, t )
{
 ...
 */
AbstractAnchor *
AnchorClosedDotArrow::clone ( AbstractEdgeShape *e,
                              AnchorType t )
{
  AbstractAnchor *ret = new AnchorClosedDotArrow ( e, t );
 ...
 */
void
AnchorClosedDotArrow::draw ( QPainter *painter ) const
{
  /* arrow */
 ...
 * Destructor
 */
AnchorClosedDotArrow::~AnchorClosedDotArrow ( )
{
}
